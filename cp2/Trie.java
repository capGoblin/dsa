...
public class Trie {
  ...
  private void traversePostOrder(Node root) { // used to delete a word in trie
  ...
  private void traversePreOrder(Node root) { // used to print a word in trie
  ...
  private void remove(Node root, String word, int index) { //PostOrderTraversal
  ...
  private void findWords(Node root, String prefix, List<String> words) { //PreOrderTraversal
    if (root == null)
      return;
  ...
  class Solution1 {
    ...
    public class Trie {
        ...
        public String longestCommonPrefix(String[] strs) {
          ...
          var prefix = new StringBuffer();
          var current = trie.root;
          var maxChars = getShortest(strs).length();
          var children = current.getChildren();
          while(prefix.length() < maxChars &&   1) {
    ...
    class Solution2 {
      public String longestCommonPrefix(String[] strs) {
          Arrays.sort(strs); //sorted lexicographically

          String first_word = strs[0];
          String last_word = strs[strs.length - 1];

          var minChWord = first_word.length() < last_word.length() ? first_word: last_word;
          
          var prefix = new StringBuffer();
          for(int i = 0; i < minChWord.length(); i++) {
